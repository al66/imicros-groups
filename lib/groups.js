...
// action addGrant { byGroupId, forGroupId, service, action, forFolderId, forRessourceId } => { byGroupId, forGroupId, service, action } only for group admins
// action removeGrant { byGroupId, forGroupId, service, action, forFolderId, forRessourceId } => { removed (forGroupId) } only for group admins
